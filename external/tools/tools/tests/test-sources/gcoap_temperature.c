...
const char fmt[] = "{\"temperature\": }";
const char fmt2[] = "Length of written string: %d\n";
const char fmt3[] = "Checking response code: %d\n";
int gcoap_temperature(bpf_coap_ctx_t *gcoap)
{
    ...
    size_t str_len = bpf_fmt_s16_dfp(fmt_buffer, avg_temperature, decimal_point);
    //bpf_printf(fmt2, str_len);

...
//     peripherals::{
//         hd44780_lcd::{hd44780_t, HD44780LCD},
//         keypad_shield_buttons::KeypadShieldButtons,
//     },
// };
...
pub const ALL_HELPERS: [HelperFunction; 7] = [
    HF::new(ID::BPF_DEBUG_PRINT_IDX, bpf_print_debug),
    HF::new(ID::BPF_PRINTF_IDX, bpf_printf),
    HF::new(ID::BPF_RAND, bpf_rand),
    HF::new(ID::BPF_MEMARRAY_INIT, bpf_memarray_init),
    HF::new(ID::BPF_MEMARRAY_ALLOC, bpf_memarray_alloc),
    HF::new(ID::BPF_MEMARRAY_CALLOC, bpf_memarray_calloc),
    HF::new(ID::BPF_MEMARRAY_FREE, bpf_memarray_free),
...
pub fn bpf_rand(a1: u64, _a2: u64, _a3: u64, _a4: u64, _a5: u64) -> u64 {
    let mut rng: Random = unsafe { Random::new_with_seed(0)};
    rng.next_u32() as u64
}

pub fn bpf_memarray_init(mem_p: u64, data_p: u64, size: u64, num: u64, _a5: u64) -> u64 {
    let mem: *mut riot_sys::memarray_t = mem_p as *mut riot_sys::memarray_t;
    let data: *mut riot_sys::libc::c_void = data_p as *mut riot_sys::libc::c_void;
    unsafe { riot_sys::memarray_init(mem, data, size as riot_sys::size_t, num as riot_sys::size_t); }
    return 0;
}

pub fn bpf_memarray_alloc(mem_p: u64, _a2: u64, _a3: u64, _a4: u64, _a5: u64) -> u64 {
    let mem: *mut riot_sys::memarray_t = mem_p as *mut riot_sys::memarray_t;
    unsafe { return riot_sys::inline::memarray_alloc(mem as *mut riot_sys::inline::memarray_t) as u64}
}

pub fn bpf_memarray_calloc(mem_p: u64, _a2: u64, _a3: u64, _a4: u64, _a5: u64) -> u64 {
    let mem: *mut riot_sys::memarray_t = mem_p as *mut riot_sys::memarray_t;
    unsafe { return riot_sys::inline::memarray_calloc(mem as *mut riot_sys::inline::memarray_t) as u64}
}

pub fn bpf_memarray_free(mem_p: u64, ptr_p: u64, _a3: u64, _a4: u64, _a5: u64) -> u64 {
    let mem: *mut riot_sys::memarray_t = mem_p as *mut riot_sys::memarray_t;
    let ptr: *mut riot_sys::libc::c_void = ptr_p as *mut riot_sys::libc::c_void;
    unsafe { riot_sys::inline::memarray_free(mem as *mut riot_sys::inline::memarray_t, ptr); }
    return 0;
}
...
//     debug!(
//         "Formatting s16 dfp args: {:?}, {:?}, {:?}, {:?}, {:?}",
//         out_p, val, fp_digits, _a4, _a5
//     );

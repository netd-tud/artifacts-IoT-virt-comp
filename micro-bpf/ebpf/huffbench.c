...
/* ==========================================
   ...
   Details:
      ...
      - provided loop based memcpy, memset, and memcmp
      - added main
      - inlined functions
      - made large stack variables global
      - used one static array instead of allocating memory
   ========================================== */
...
static inline int verify_benchmark(unsigned int r);
...
int verify_benchmark(unsigned int res)
{

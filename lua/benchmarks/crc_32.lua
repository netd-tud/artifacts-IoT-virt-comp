...
local function crc32pseudo()
    local oldcrc32 = 0xFFFFFFFF
    for _ = 1, 1024 do
        local octet = rand_beebs()
        local index = ((oldcrc32 ~ octet) & 0xFF) + 1
        oldcrc32 = (crc_32_tab[index] ~ (oldcrc32 >> 8)) & 0xFFFFFFFF
    end
